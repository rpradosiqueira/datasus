...
#'
#' @usage sim_pinf10_mun(linha = "Município", coluna = "Não ativa",
...
#' sim_pinf10_mun(municipio = 500270)
#' }
#'
...
sim_pinf10_mun <- function(linha = "Munic\u00edpio", coluna = "N\u00e3o ativa", conteudo = 1, periodo = "last", municipio = "all", capital = "all",
  ...
  page <- xml2::read_html("http://tabnet.datasus.gov.br/cgi/deftohtm.exe?sim/cnv/pinf10br.def")
  ...
  site <- httr::POST(url = "http://tabnet.datasus.gov.br/cgi/tabcgi.exe?sim/cnv/pinf10br.def",
                     body = form_data)
