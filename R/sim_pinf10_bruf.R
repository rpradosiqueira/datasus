...
#' and states.
#'
#' @usage sim_pinf10_bruf(linha = "Região", coluna = "Não ativa",
...
sim_pinf10_bruf <- function(linha = "Regi\u00e3o", coluna = "N\u00e3o ativa", conteudo = 1, periodo = "last", regiao = "all",
  ...
  page <- xml2::read_html("http://tabnet.datasus.gov.br/cgi/deftohtm.exe?sim/cnv/pinf10uf.def")
