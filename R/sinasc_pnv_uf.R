...
#'
#' @usage sinasc_pnv_uf(uf, linha = "Município", coluna = "Não ativa",
...
sinasc_pnv_uf <- function(uf, linha = "Munic\u00edpio", coluna = "N\u00e3o ativa", conteudo = 1, periodo = "last", municipio = "all", cir = "all",
  ...
  page <- xml2::read_html(paste0("http://tabnet.datasus.gov.br/cgi/deftohtm.exe?sinasc/cnv/pnv",uf,".def"))
  ...
  site <- httr::POST(url = paste0("http://tabnet.datasus.gov.br/cgi/tabcgi.exe?sinasc/cnv/pnv", uf,".def"),
                     body = form_data)
